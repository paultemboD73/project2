...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
	 ...
	 <?php
		    ...
		    $luxury_shop_post_id = get_the_ID(); // Add this line to get the post ID
		    $luxury_shop_single_content_setting = get_post_gallery();

		    if (!empty($luxury_shop_single_content_setting)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($luxury_shop_single_content_setting) . '</div>';
		    }
		?>
    <?php
