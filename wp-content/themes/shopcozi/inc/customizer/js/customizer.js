( function( api ) {
    ...
    api.sectionConstructor['shopcozi-pro'] = api.Section.extend( {
		...
		_init: function() {
            ...
            control.actions = function ($context) {
                if (control.params.live_title_id) {
                    ...
                    if (control.id === 'shopcozi_section_order_styling') {
    ...
    function _the_editor( container ){
        var _editor = {
            ...
            ready: function( container ) {
                ...
                control.container.addClass( 'shopcozi-editor-added' );
...
jQuery( window ).ready( function( $ ){
    ...
    if ( typeof shopcozi_customizer_settings !== "undefined" ) {
        if (shopcozi_customizer_settings.number_action > 0) {
            $('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + shopcozi_customizer_settings.action_url + '">' + shopcozi_customizer_settings.number_action + '</a>');
        }
    }
     ...
     */
    $( 'select[data-customize-setting-link="shopcozi_hero_layout"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-shopcozi_hcl']").hide();
        $( "li[id^='customize-control-shopcozi_hcl"+v+"']").show();

    } );

    $( 'select[data-customize-setting-link="shopcozi_hero_layout"]').trigger( 'on_custom_load' );

    /**
     * For Gallery content settings
     */
    $( 'select[data-customize-setting-link="shopcozi_gallery_source"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-shopcozi_gallery_source_']").hide();
        $( "li[id^='customize-control-shopcozi_gallery_api_']").hide();
        $( "li[id^='customize-control-shopcozi_gallery_settings_']").hide();
        $( "li[id^='customize-control-shopcozi_gallery_source_"+v+"']").show();
        $( "li[id^='customize-control-shopcozi_gallery_api_"+v+"']").show();
        $( "li[id^='customize-control-shopcozi_gallery_settings_"+v+"']").show();

    } );

    $( 'select[data-customize-setting-link="shopcozi_gallery_source"]').trigger( 'on_custom_load' );

    /**
     * For Gallery display settings
     */
    $( 'select[data-customize-setting-link="shopcozi_gallery_display"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';
        switch ( v ) {
            case 'slider':
                $( "#customize-control-shopcozi_g_row_height, #customize-control-shopcozi_g_col, #customize-control-shopcozi_g_spacing").hide();
                break;
            case 'justified':
                $( "#customize-control-shopcozi_g_col, #customize-control-shopcozi_g_spacing").hide();
                $( "#customize-control-shopcozi_g_row_height").show();
                break;
            case 'carousel':
                $( "#customize-control-shopcozi_g_row_height, #customize-control-shopcozi_g_col").hide();
                $( "#customize-control-shopcozi_g_col, #customize-control-shopcozi_g_spacing").show();
                break;
            case 'masonry':
                $( "#customize-control-shopcozi_g_row_height").hide();
                $( "#customize-control-shopcozi_g_col, #customize-control-shopcozi_g_spacing").show();
                break;
            default:
                $( "#customize-control-shopcozi_g_row_height").hide();
    ...
    $( 'select[data-customize-setting-link="shopcozi_gallery_display"]').trigger( 'on_custom_load' );
...
jQuery( document ).ready( function( $ ) {
    ...
    display_footer_layout( $( '#customize-control-shopcozi_footer_middle_columns select' ).val() );
    $( '#customize-control-shopcozi_footer_middle_columns select' ).on( 'change', function ()  {
